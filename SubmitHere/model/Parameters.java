...
//    "uncor1" - Uncorrelated One StepMutation
    ...
    //    INDIVIDUAL
    public static double def_sigma = 0.9;
    public static double def_eps = 0.000;
    public static double epsMax = 2.0;
